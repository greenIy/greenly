  ...
  <div class="page-container">
    ...
    <body>
      <div class="content-wrap">
        ...
        >
          <li role="button" class="nav-item" data-cy="dashboard-transporter-orders-pill">
            <a
              ...
              :class="{
                active:
                  this.$route.name == 'transportador' ||
                  this.$route.name == 'transportador_historico',
              }"
              >Encomendas</a
            >
          </li>
          <li role="button" class="nav-item" data-cy="dashboard-transporter-centers-pill">
            <a
              ...
              @click="activate(2)"
              :class="{
                active: this.$route.name == 'transportador_centros_dist',
              }"
          ...
          <li role="button" class="nav-item" data-cy="dashboard-transporter-vehicles-pill">
            <a
              ...
              role="tab"
              @click="activate(3)"
              :class="{ active: this.$route.name == 'transportador_veiculos' }"
              >Veículos</a
            >
          </li>
        </ul>
        ...
        >
          ...
          <div class="d-inline-block margin-btn">
            ...
            <button
              type="button"
              class="btn btnHist"
              v-if="this.$route.name == 'transportador_historico'"
              @click="hideHistory()"
            >
              <font-awesome-icon
                class="fs-6 fa-fw mx-1 icon"
        ...
        <div v-if="this.$route.name == 'transportador'">
          <EncomendasDashboard
            :receiveData="receiveData"
            @updateStatus="updateStatus"
          />
        </div>
        <div v-if="this.$route.name == 'transportador_centros_dist'">
          <DistributionCenters
            :receiveData="receiveData"
            @updateStatus="updateStatus"
          />
        </div>
        <div v-if="this.$route.name == 'transportador_veiculos'">
          <Vehicles :receiveData="receiveData" @updateStatus="updateStatus" />
        </div>
