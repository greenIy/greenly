<template>
  ...
  <hr />
  <i
    >As suas informações pessoais não são publicas aos restantes consumidores da
    plataforma Greenly.<br />Apenas os admistradores, fornecedores e
    transportadores que estiveram e/ou estarão envolvidos num processo de
    entrega de umas das suas encomendas têm também acesso a estas informações.
  </i>
  <br />
  <br />
  <form @submit.prevent="editProfile">
    <div class="d-flex fieldWrapper">
      <div class="entryField">
        <label for="inputFirstName" class="form-label"
          >Nome <span style="color: #ff0000">*</span></label
        >
        <input
          type="name"
          class="form-control"
      ...
      <div class="entryField">
        <label for="inputLastName" class="form-label"
          >Apelido <span style="color: #ff0000">*</span></label
        >
        <input
          type="name"
          class="form-control"
    ...
    <div class="d-flex fieldWrapper">
      ...
      <div class="entryField">
        <label for="inputPhoneNumber" class="form-label"
          >Telemóvel <span style="color: #ff0000">*</span></label
        >
        <input
          type="number"
          class="form-control"
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
      ...
      >
        <font-awesome-icon :icon="['fa', 'pen']" /> &nbsp;Editar
      </button>
      <button
        type="button"
  ...
  <div
    ...
    tabindex="-1"
    aria-labelledby="cancelUserInfoLabel"
    aria-hidden="true"
  >
...
export default {
  ...
  methods: {
    ...
    saveUserInfo() {
      this.cancelUserInfo();
      this.toast.success(
        "Atualizado! O seu perfil foi atualizado com sucesso.",
        {
          position: "top-right",
          timeout: 5000,
          closeOnClick: true,
