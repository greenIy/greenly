    ...
    <div style="width: 95%; margin-left: 5px; margin-bottom: 5px">
      <form @submit.prevent="changePassword">
        <div class="d-flex">
          <div class="inputWrapper1">
            ...
            <div class="input-group">
              ...
              <div class="invalid-feedback" id="invalidFeedbackOldPassword">
                Palavra-passe inserida não coincide com a atual.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="inputWrapper2">
            ...
            <div class="input-group">
              ...
              <div
                ...
                id="invalidFeedbackNewPassword"
              ></div>
            </div>
          </div>
          <div class="inputWrapper2">
            <label for="inputNewPasswordConfirm" class="form-label"
            ...
            <div class="input-group">
              <input
                ...
                v-model="changePW.newPasswordConfirm"
              ...
              <div class="input-group-append">
                ...
                >
                  <font-awesome-icon
                    :icon="showPassword3 ? ['fa', 'eye-slash'] : ['fa', 'eye']"
                  />
                </span>
              </div>
            </div>
        ...
        <button type="submit" class="btn btn-secondary">
          <font-awesome-icon :icon="['fa', 'key']" /> &nbsp;Mudar palavra-passe
        </button>
      </form>
      <br />
      <br />
      ...
      <hr />
      <a
        >Procura desenvolver aplicações utilizando o API Greenly? Utilize este
        token para se autenticar. <br /><b
          >Deve tratá-lo com todo o cuidado, pois este token permite acesso à
          sua conta.</b
        >
        <br />Consulte todas as funcionalidades do API em
        <a :href="url_api">docs.greenly.pt</a>.</a
      >
      <br />
      <br />
      <p>
        <button
          ...
          data-bs-target="#accessTokenCollapse"
          aria-expanded="false"
          aria-controls="accessTokenCollapse"
          @click="changeAccessTokenIcon"
        >
          <span
            ><font-awesome-icon
              :icon="showAccessToken ? ['fa', 'lock-open'] : ['fa', 'lock']"
            />
            &nbsp;Mostrar token</span
          >
        </button>
      ...
      <div style="min-height: 50px">
        <div class="collapse" id="accessTokenCollapse">
          <div
            ...
            style="width: 100%; margin-bottom: 30px; background-color: #ededed"
          >
            <span class="small">{{
              this.accessToken.replaceAll('"', "")
            }}</span>
          </div>
        </div>
      </div>
      ...
      <hr />
      <a
        >Depois de apagar a sua conta, <b>não há como voltar atrás</b>.<br />Por
        favor tenha isso em consideração antes de tomar uma decisão.</a
      >
      <br />
      <br />
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div
              class="modal-body"
              id="checkIcon"
              style="width: 15%; margin-left: 42.5%; display: none"
            >
...
export default {
  ...
  methods: {
    ...
    successfulChangePassword() {
      ...
      this.toast.success(
        "Atualizada! A sua palavra-passe foi atualizada com sucesso.",
        {
          position: "top-right",
          timeout: 5000,
          closeOnClick: true,
    ...
    successfulDelete() {
      ...
      document.getElementById("deleteMessage").innerHTML =
        "<div class='text-center'>Conta apagada com sucesso!<br>Irá ser redirecionado para a página de login...<br><div>";
    ...
    wrongCredentials(message) {
      if (message == "old_password doesn't match user password.") {
        ...
        document.getElementById("invalidFeedbackNewPassword").innerText =
          "Palavra-passe nova deve conter pelo menos 5 caracteres.";
        document.getElementById("newPassword").classList.add("is-invalid");
      } else if (message == "old_password can't be the same as new_password") {
        document.getElementById("invalidFeedbackNewPassword").innerText =
          "Palavra-passe nova deve ser diferente da atual.";
        document.getElementById("newPassword").classList.add("is-invalid");
      }
      document.getElementById("oldPassword").value = "";
      document.getElementById("newPassword").value = "";
