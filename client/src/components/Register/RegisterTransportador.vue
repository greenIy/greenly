<template>
    <div class="container h-100 d-flex justify-content-center">
        <div class="card p-3 justify-content-center align-items-center 2" style="max-width: 600px; min-width: 350px">
            <div class="card-body">
                <form @submit.prevent="registerTransporter">   
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="name" class="form-control" id="firstName" v-model="registerInfo.firstName" placeholder="Nome" required data-cy="transporter-first-name">
                        </div>
                        <div class="col-md-6">
                            <label for="inputLastName" class="form-label">Apelido <span style='color: #FF0000;'>*</span></label>
                            <input type="name" class="form-control" id="lastName" v-model="registerInfo.lastName" placeholder="Apelido" required data-cy="transporter-last-name">
                        </div>
                    </div>
                    <div class="row g-3 mt-1">
                        <div class="col">
                            <label for="inputEmail" class="form-label">E-mail <span style='color: #FF0000;'>*</span></label>
                            <input type="email" v-on:click="removeIsInvalid" class="form-control" id="email" v-model="registerInfo.email" placeholder="E-mail" required data-cy="transporter-email">
                    ...
                    <div class="row g-3 mt-1">
                        <div class="col-md-6">
                            ...
                            <input :type="showPassword1 ? 'text' : 'password'" v-on:click="removeIsInvalid" class="form-control" id="password" v-model="registerInfo.password" placeholder="Palavra-passe" required data-cy="transporter-password"> 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                            <input :type="showPassword2 ? 'text' : 'password'" v-on:click="removeIsInvalid" class="form-control" id="passwordConfirm" v-model="registerInfo.passwordConfirm" placeholder="Palavra-passe" required data-cy="transporter-repeat-password">   
                                <div class="input-group-append">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="name" class="form-control" id="companyName" v-model="registerInfo.companyName" placeholder="Nome" required data-cy="transporter-company-name">
                        </div>
                        <div class="col-md-6">
                            <label for="inputComapnyEmail" class="form-label">Email empresa <span style='color: #FF0000;'>*</span></label>
                            <input type="name" class="form-control" v-on:click="removeIsInvalid" id="companyEmail" v-model="registerInfo.companyEmail" placeholder="Email" required data-cy="transporter-company-email">
                            <div class="invalid-feedback">E-mail não tem o formato correto ou e-mail já em uso.</div>
                        </div>
                    </div>
                    
                    <div class="mt-3 mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="termsConditons" required data-cy="transporter-accept-terms">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary" id="registerButton" style="width: 65%;">Registar como Transportador&nbsp;&nbsp;<img  src="../../assets/leaf.png" class="mb-1" alt="Folha" style="width:7%" data-cy="transporter-submit"/></button>
                    </div>
                </form>
            </div>
