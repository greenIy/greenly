            ...
            <div class="card-body">
                <form @submit.prevent="registerTransporter">   
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary" id="registerButton" style="width: 65%; margin-left: 17.5%;">Registar como Transportador&nbsp;&nbsp;<img  src="../../assets/leaf.png" class="mb-1" alt="Imagem do produto" style="width:7%" /></button>
                    </div>
                </form>
            </div>
