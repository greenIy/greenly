        ...
        <div class="navmenu d-flex justify-content-center pt-2 pb-2">
            ...
            <div class="input-group search-group align-self-center mt-2 mb-2 ms-4">
                <input class="form-control" type="search" placeholder="O que estás à procura?" aria-label="Search"
                    v-model="search" @keyup.enter="submit(this.search)">
                <button class="btn btnSearchBar btn-outline-success" type="submit"
                    @click="submit(this.search)">Pesquisar</button>
            </div>
                ...
                <div class="align-self-center nav-links mt-2 mb-2 ml-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu mt-3" aria-labelledby="dropdownMenuLink">
                            <li>
                                <router-link to="/perfil/detalhes" style="margin-left: 0"><a class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'id-card']" />&nbsp; Perfil</a></router-link>
                            </li>
                            <li v-if="user.type == 'CONSUMER'">
                                <router-link to="/perfil/encomendas" style="margin-left: 0"><a
                                        class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'box-archive']" />&nbsp; Encomendas</a>
                                </router-link>
                            </li>
                            <li v-if="user.type == 'CONSUMER'">
                                <router-link to="/perfil/favoritos" style="margin-left: 0"><a
                                        class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'heart']" />&nbsp; Favoritos</a></router-link>
                            </li>
                            <li v-if="user.type === 'ADMINISTRATOR'">
                                <router-link to="/administracao"
                                    style="margin-left: 0"><a class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'table-columns']" size="" />&nbsp; Administração</a>
                                </router-link>
                            </li>
                            <li>
                                <router-link v-if="user.type === 'SUPPLIER'" :to="{ name: 'fornecedor' }"
                                    style="margin-left: 0"><a class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'box-archive']" size="" />&nbsp; Painel de gestão</a>
                                </router-link>
                            </li>
                            <li>
                                <router-link v-if="user.type === 'TRANSPORTER'" :to="{ name: 'transportador' }"
                                    style="margin-left: 0"><a class="dropdown-item ms-0">
                                        <font-awesome-icon :icon="['fa', 'box-archive']" size="" />&nbsp; Painel de gestão</a>
                                </router-link>
                            </li>
                            ...
                            <li>
                                <router-link to="/login" v-on:click="logoutUser" style="margin-left: 0;"><a
                                        class="dropdown-item ms-0" style="color: red !important">
                                        <font-awesome-icon :icon="['fa', 'arrow-right-from-bracket']" />&nbsp; Terminar
                                        sessão</a></router-link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div v-if="userIsLoggedIn" class="align-self-center nav-links mt-2 mb-2 ml-3">
                <div class="dropdown">
                    <span v-if="activeNotificationsLength() > 0"
                    ...
                    <a class="" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
                        ...
                        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true">
                                    <font-awesome-icon :icon="['fa', 'inbox']" />&nbsp;Novas&nbsp;<span
                                        v-if="activeNotificationsLength() > 0"
                                        class="badge bg-custom">{{ this.activeNotificationsLength() }}</span></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false">
                                    <font-awesome-icon :icon="['fa', 'clock-rotate-left']" />&nbsp;Arquivadas</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                aria-labelledby="pills-home-tab" style="overflow-y: auto; max-height: 550px;">
