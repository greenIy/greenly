        ...
        <div class="card p-3 justify-content-center align-items-center mt-5 mb-5" style="width: 350px">
            <div class="card-body">
                <form @submit.prevent="loginUser">
                    ...
                    <button type="submit" class="btn btn-primary" style="width: 100%" id="loginButton">Iniciar&nbsp;&nbsp;<img  src="../../assets/leaf.png" class="mb-1" alt="Folha" style="width:7%" data-cy="login-submit"/></button>
