<template>
  <div class="d-flex align-items-end my-3 justify-content-end me-1">
    <div class="text-end mx-1">
      <span class="text-secondary contentInPage fs-6">
        {{ getInitialAmountOfProducts }} - {{ getFinalAmountOfProducts }} de
        {{ productAmount }} produtos
      </span>
    </div>
    <div class="text-end mx-3">
      <div class="dropdown">
        <a
          class="btn rounded text-decoration-none"
          id="order-by-numbers"
        ...
        <ul class="dropdown-menu drop" aria-labelledby="order-by-numbers">
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, por_pag: 12 } }"
              class="dropdown-item"
              >12</router-link
            >
          </li>
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, por_pag: 24 } }"
              class="dropdown-item"
              >24</router-link
            >
          </li>
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, por_pag: 48 } }"
              class="dropdown-item"
              >48</router-link
            >
          </li>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="order-by-filters">
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, ordenar_por: 'name_asc' } }"
              class="dropdown-item"
              style="width: 12rem"
              >Nome</router-link
            >
          ...
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, ordenar_por: 'newest' } }"
              class="dropdown-item"
              style="width: 12rem"
              >Novidade</router-link
            >
          </li>
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, ordenar_por: 'price_asc' } }"
              class="dropdown-item"
              style="width: 12rem"
              >Preço Ascendente</router-link
            >
          </li>
          <li>
            <router-link
              append
              :to="{ query: { ...$route.query, ordenar_por: 'price_desc' } }"
              class="dropdown-item"
              style="width: 12rem"
              >Preço Descendente</router-link
            >
          </li>
        </ul>
      </div>
