<template>
	<div class="container mt-5">
		<div class="row align-items-start">
            <div class="row align-items-start">
                <div class="row">
                        <button type="button" class="btn btn-secondary ms-3 mb-3" data-bs-toggle="modal" data-bs-target="#modalNewItem" style="width: 15%"><font-awesome-icon :icon="['fa', 'plus']" />&nbsp; Criar fornecimento</button>
                </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" :id="'heading' + item.id">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <span><font-awesome-icon :icon="['fa', 'calendar']" />&nbsp; {{ `${String(new Date(item.production_date).getDate()).padStart(2, '0')}/${String(new Date(item.production_date).getMonth()+1).padStart(2, '0')}/${new Date(item.production_date).getFullYear()}` }}</span>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="accordion-body">
                                <div class="row ms-4 mt-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="ms-3">
                                            <div class="card mt-3 mb-3" style="width: 550px; height: 250px;">
                ...
                <form @submit.prevent="newItem">
                    ...
                    <div class="row mb-2">
                        <div class="col mb-3">
                            ...
                            <input type="date" class="form-control" id="newItemProductionDate" v-model="newItemInfo.production_date" required>
                        </div>
                        <div class="col mb-3">
                            <label for="newExpirationDate" class="form-label">Data de validade <span style='color: #FF0000;'>*</span></label>
                            <input type="date" class="form-control" id="newExpirationDate" v-model="newItemInfo.expiration_date" required>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row justify-content-center" style="max-height: 500px; overflow-y: auto;">
                        ...
                        <div v-else class="text-center mt-3 mb-3">
                            <p>Parece que não tem armazéns associados à sua conta. Adicione um!</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
import { faTruck, faGasPump, faOilCan, faChargingStation, faBolt, faSkullCrossbones, faBox, faPlus, faUpRightAndDownLeftFromCenter, faTrash, faLeaf, faTag } from "@fortawesome/free-solid-svg-icons";
library.add(faTruck, faGasPump, faOilCan, faChargingStation, faBolt, faSkullCrossbones, faBox, faPlus, faUpRightAndDownLeftFromCenter, faTrash, faLeaf, faTag);
...
export default {
	...
	data() {
        ...
        return {
			...
			inventory: [],
			inventoryLength: 1,
			selectedItem: {warehouse:{address:{}}, total_vehicles:'', capacity:''},
			map: {},
            newItemInfo: {
                distribution_center: '',
                license_plate: '',
